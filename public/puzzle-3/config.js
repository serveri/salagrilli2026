...
Game.INSPECT_MESSAGES = {
    ...
    1750: ['Locked, I should have guessed when coming here'], 3072: ['The light bulb is burning into my eyes!'], 3136: ['Put that light away!'], 612: ['Books: Tux Linux - GNU/Linux 101: The importance of programming socks,', '.. Chad.Gepede - How to craft a nuclear device, in Minecraft'], 676: ['Books: Tux Linux - GNU/Linux 101: The importance of programming socks,', '.. Chad.Gepede - How to craft a nuclear device, in Minecraft'],
...
Game.LOCKED_DOORS = {
    'serveriquest': [
        { x: 38, y: 52, requiredItem: 'home_key', msgMissing: ['The door to my house is locked!', 'I need my Home Key to get inside.', 'Maybe somebody brought my home key to the CS department'], msgHasItem: null }
    ],
    'savilahti': [
