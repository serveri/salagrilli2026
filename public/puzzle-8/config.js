...
Game.WALKABLE_TILES = new Set([
    ...
    2949, 2950, 2951, 2952, 3013, 3014, 3015, 3016, 2769, 2897
]);
...
Game.INSPECT_MESSAGES = {
    ...
    3273: ['Toyota Corolla', 'Definitely not compensating for anything'], 3274: ['Toyota Corolla', 'Definitely not compensating for anything'], 3211: ['Toyota Corolla', 'Definitely not compensating for anything'], 3275: ['Toyota Corolla', 'Definitely not compensating for anything'],
};
