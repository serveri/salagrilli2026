...
Game.SIGN_MESSAGES = {
    ...
    'serveriquest_75_47': ['Berries are a good snack!', 'You can eat them from a bush, but only once', 'There are multiple other energy restoring items, interract with items on the ground to collect them'],
